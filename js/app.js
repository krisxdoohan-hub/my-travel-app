...
methods: {
        ...
        confirmDeleteDay() {
            ...
            this.showDayActionMenu = false; // 先關閉選單
        ...
        getCategoryIcon(cat) {
            const icons = { '景點': '⛩️', '住宿': '🏨', '車站': '🚉', '交通': '🚇', '交通方式': '🚇', '機場': '🛫', '港口': '🚢', '航班': '✈️', '餐廳': '🍽️', '備選餐廳': '🍽️', '美食': '🍜', '購物': '🛍️', '其他': '📍' };
            return icons[cat] || '📍';
        },
        addTodo() {
